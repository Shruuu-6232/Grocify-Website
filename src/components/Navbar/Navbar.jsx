...
const Navbar = () => {
    ...
    return (
        <header className={`bg-white fixed top-0 right-0 left-0 z-50 transition-all duration-300 ${isScrolled ? 'shadow-lg' : ''}`}>
            <nav className='max-w-[1400px] mx-auto px-10 md:h-[14vh] h-[12vh] flex justify-between items-center'>
                ...
                <div className='flex items-center gap-x-5'>
                    ...
                    {/* INPUT FIELD */}
                    <div className='md:flex p-1 items-center border-2 border-orange-500 pr-2 rounded-full hidden'>
                    ...
                    {/* HAMBURGER */}
                    <a href="#" className='text-zinc-900 text-3xl md:hidden' onClick={toggleMenu}>
